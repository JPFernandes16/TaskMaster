...
<title>TaskMaster - Registo</title>
...
<main class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-6 bg-white p-5 rounded shadow">
      <h2 class="text-center form-title mb-4">Registo</h2>
      <% 
      ...
      %>
      <div class="alert alert-danger" role="alert">
        Falha ao registar. Por favor, tente novamente.
      </div>
      <% 
          }
        }
      ...
      <form method="post" action="Register">
        <div class="mb-3 row">
          <label for="nome" class="col-sm-3 col-form-label labels">Nome:</label>
          <div class="col-sm-9">
        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            <button type="submit" class="btn btn-success btn-lg btn-block">Registar</button>
          </div>
        </div>
      </form>
    </div>
